...
//    static final double L1_AB = 1000;
    static final double L1_AB = 810;

    //大臂三角形上赶长
//    static final double L1_BC = 850;
    static final double L1_BC = 722;
    ...
    static final double arm1_y = 290;
    static final double arm1_z = 130;
    static final double arm2_x = 750;
    static final double arm2_y = 240;
    static final double arm2_z = 130;
    static final double dipper_x = 900;
    static final double dipper_y = 250;
    static final double dipper_z = 200;
    static final double bucket_x = 390;
    static final double bucket_y = 300;
    static final double bucket_z = 360;
    static final double Lbias_arm1=25;
    static final double Lbias_arm2=70;
    static final double Lbias_dipper=60;
    ...
    public static void changehand(handJointInfo currentHandJointInfo) {
        ...
        arm1.point.x = L1_AB
                ...
                * Utils.cos(theta2t) / 2
                + a0
                * Utils.cos(theta1)
                +Lbias_arm1*arm1.vectors[1].vextorX;
        arm1.point.y = L1_AB
                * Utils.cos(theta2t)
                * Utils.sin(theta1) / 2
                + a0 * Utils.sin(theta1)
                +Lbias_arm1*arm1.vectors[1].vextorY;
        arm1.point.z = L1_AB
                * Utils.sin(theta2t) / 2
                + d0
                +Lbias_arm1*arm1.vectors[1].vextorZ;
        ...
        arm2.point.x = (pb.x + pc.x) / 2+Lbias_arm2*arm2.vectors[1].vextorX;
        arm2.point.y = (pb.y + pc.y) / 2+Lbias_arm2*arm2.vectors[1].vextorY;
        arm2.point.z = (pb.z + pc.z) / 2+Lbias_arm2*arm2.vectors[1].vextorZ;
        ...
        dipper.point.x = (pc.x + pd.x) / 2+Lbias_dipper*dipper.vectors[1].vextorX;
        dipper.point.y = (pc.y + pd.y) / 2+Lbias_dipper*dipper.vectors[1].vextorY;
        dipper.point.z = (pc.z + pd.z) / 2+Lbias_dipper*dipper.vectors[1].vextorZ;
